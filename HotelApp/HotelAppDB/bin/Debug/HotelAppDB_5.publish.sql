...
:setvar DefaultDataPath "C:\Users\HOME\AppData\Local\Microsoft\Microsoft SQL Server Local DB\Instances\MSSQLLocalDB\"
:setvar DefaultLogPath "C:\Users\HOME\AppData\Local\Microsoft\Microsoft SQL Server Local DB\Instances\MSSQLLocalDB\"
...
GO
PRINT N'The following operation was generated from a refactoring log file 16293a82-930e-4a53-b00f-dd0cce3be1a0';

PRINT N'Rename [dbo].[RoomTypes].[Ttile] to Title';


GO
EXECUTE sp_rename @objname = N'[dbo].[RoomTypes].[Ttile]', @newname = N'Title', @objtype = N'COLUMN';
...
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '16293a82-930e-4a53-b00f-dd0cce3be1a0')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('16293a82-930e-4a53-b00f-dd0cce3be1a0')
