...
begin
    insert into dbo.RoomTypes(Ttile, Description)
    values
    ('King Size Bed', ' A room with a king-size bed and a window.'),
    ('Two Queen Size Bed', ' A room with two queen-size beds and a window.'),
    ('Executive Suite', ' Two rooms, each room with a king-size bed and a window.');
end
